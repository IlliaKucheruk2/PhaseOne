  ...
  <body>
    ...
    <div class="container">
      <header class="jumbotron my-5">
        ...
        <p class="lead">We are glad that you chose us</p>
        <hr class="my-4">
      </header>
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="first_name"
                 required placeholder="Herman" value="<?= $form_values
                 ['first_name'] ?? null ?>">
              </div>
            </div>
            <div class="col">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="last_name" required placeholder="Enter your name" value="<?= $form_values['last_name'] ?? null ?>">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="form-group">
                ...
                <input class="form-control" type="email" name="email_confirmation" placeholder="example@example.com" required value="<?= $form_values['email_confirmation'] ?? null ?>">
              </div>
            </div>
          </div>
